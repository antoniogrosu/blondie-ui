  ...
  return (
    <div className="flex items-center md:pb-24 pb-16 justify-between">
      <div className="4/12">
        ...
        <button className="transition poppins mt-8 px-4 py-2 bg-pink-500 hover:bg-pink-600 text-pink-50 rounded-full">
          <img
            src="/plane.svg"
        ...
        <button className="transition hover:bg-pink-500/10 poppins mt-8 px-4 py-2 bg-transparent text-pink-500 border-2 border-pink-500 ml-8 rounded-full">
          Despre noi{" "}
        </button>
      </div>
